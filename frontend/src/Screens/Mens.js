...
const fetchProducts = async () => {
  ...
  return [
    {
      id: 1,
      name: 'Men Contrast Geo Tape Drop Shoulder Kimono',
      price: 1000,
      image: 'https://i.pinimg.com/564x/1b/60/6d/1b606d46f39c46275175159eed691996.jpg',
    },
    {
      id: 2,
      name: 'Men Solid Shirt & Drawstring Waist Trousers',
      price: 1200,
      image: 'https://i.pinimg.com/564x/9e/12/ce/9e12ceec4ef813d08bc023afc6fcb2bf.jpg',
    },
    {
      id: 3,
    ...
    {
      id: 4,
      name: 'Ceekoo Shirts For Men',
      price: 1100,
      image: 'https://i.pinimg.com/564x/e3/ef/36/e3ef36c865a4672c9996cd14b92e125d.jpg',
    },
    {
      id: 5,
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-semibold">Mens👦</h1>
